...
penguins %>%
  ...
  summarize(mean_bill_length_mm=mean(bill_length_mm, na.rm=T), mean_flipper_length_mm=mean(flipper_length_mm, na.rm=T), mean_body_mass_g=mean(body_mass_g, na.rm=T), n=n())
```
...
penguins %>%
  filter(species=="Adelie") %>%
  select(bill_length_mm, flipper_length_mm, body_mass_g) %>%
  summarize(mean_bill_length_mm=mean(bill_length_mm, na.rm=T), mean_flipper_length_mm=mean(flipper_length_mm, na.rm=T), mean_body_mass_g=mean(body_mass_g, na.rm=T), sd_billlength=sd(bill_length_mm, na.rm=T), sd_flipper=sd(flipper_length_mm, na.rm=T), sd_bodymass=sd(body_mass_g, na.rm=T), n=n())
```
```{r}
penguins %>%
