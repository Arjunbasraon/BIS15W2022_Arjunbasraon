...
both of these plots present different information, the first heatmap tells about the number of bugs while the second one tells about the ratio between bugs recorded and the maximum number of bugs.
