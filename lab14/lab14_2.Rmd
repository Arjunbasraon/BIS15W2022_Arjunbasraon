...
ggVennDiagram(fly_or_swim_list, category.names = c("Flying", "Swim"))
```
...
venn_plot <- ggVennDiagram(fly_or_bird_list, category.names = c("Fly", "Bird"), edge_size = 5)

venn_plot +
  scale_fill_distiller(palette = "The Simpsons")+ #distiller is for discrete data
...
```{r}
practicevenn1_list <- list(swimming_vec, carni_vec, aqua_vec, ecto_vec)
ggVennDiagram(practicevenn1_list, category.names = c("swim", "carnivore", "aquatic", "ectotherms"))
```
